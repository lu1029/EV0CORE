DROP FUNCTION IF EXISTS get_conversations(UUID, INTEGER, INTEGER);
...
-- Revoke/Grant
REVOKE EXECUTE ON FUNCTION get_conversations(INTEGER, INTEGER) FROM PUBLIC;
REVOKE EXECUTE ON FUNCTION get_conversations(INTEGER, INTEGER) FROM anon;
GRANT EXECUTE ON FUNCTION get_conversations(INTEGER, INTEGER) TO authenticated;
