    ...
    <>
      ...
      >
        ...
        <div className="flex items-center gap-3 px-4 pt-4 pb-3">
          <button onClick={goToProfile} className="w-10 h-10 rounded-full bg-secondary flex items-center justify-center overflow-hidden ring-2 ring-primary/20 active:scale-95 transition">
          ...
          <div className="flex-1 min-w-0">
            <button onClick={goToProfile} className="text-sm font-semibold truncate hover:underline">
        ...
        <div className="flex items-center gap-1 px-3 py-2 mt-1">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 h-10 rounded-full active:scale-95 transition hover:bg-secondary/50"
          >
      ...
      {commentsOpen && (
        <CommentsSheet
          ...
          onCountChange={(d) => setCommentsCount(c => Math.max(0, c + d))}
        />
      )}
    </>
  );
