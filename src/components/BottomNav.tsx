        ...
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              className={`flex flex-col items-center gap-0.5 px-3 py-1.5 rounded-xl transition-all duration-300 min-w-[48px] min-h-[48px] justify-center active:scale-90 ${
                isActive
                  ? "text-primary"
            ...
            >
              ...
              {isActive && (
                <div className="w-1 h-1 rounded-full gradient-primary mt-0.5 animate-scale-in" />
              )}
            </button>
          );
        })}
